namespace ScientificCalculator
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnFact
            // 
            btnFact.Font = new Font("Segoe UI", 16.2F, FontStyle.Bold, GraphicsUnit.Point);
            btnFact.Location = new Point(632, 432);
            btnFact.Margin = new Padding(3, 2, 3, 2);
            btnFact.Name = "btnFact";
            btnFact.Size = new Size(117, 77);
            btnFact.TabIndex = 41;
            btnFact.Text = "n!";
            btnFact.UseVisualStyleBackColor = true;
            btnFact.Click += factorialCalculation;
            // 
            // btnOct
            // 
            ...
            // btnModule
            // 
            btnModule.Font = new Font("Segoe UI", 16.2F, FontStyle.Bold, GraphicsUnit.Point);
            btnModule.Location = new Point(509, 432);
            btnModule.Margin = new Padding(3, 2, 3, 2);
            btnModule.Name = "btnModule";
            btnModule.Size = new Size(117, 77);
            btnModule.TabIndex = 38;
            btnModule.Text = "|x|";
            btnModule.UseVisualStyleBackColor = true;
            btnModule.Click += moduleCalculation;
            // 
            // Form1
            // 
